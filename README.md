...
Richer policy builders, policy reconciliation/removal when requests stop matching, RBAC for policy management and overrides, surfacing policy names in the gate response, request approval timeline / analytics, SLA / calendar reminders, and PowerSync sync rules are tracked as follow-ups.
