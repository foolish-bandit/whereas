...
const DEMO_CLAUSE_TEMPLATES: ClauseTemplate[] = [
  ...
  // PR #119 — additional seeds so the contract-type selector has
  // visible variety across NDA, MSA, Vendor, Employment, and DPA in
  // demo mode. Sample language is short and fictional.
  { id: "ct-5", organization_id: "demo-org", name: "Vendor termination for convenience", clause_type: "termination", text: "Customer may terminate this Agreement for convenience on 30 days' written notice.", description: "Standard 30-day termination for vendor agreements.", jurisdiction: null, contract_type: "vendor_agreement", version: "1.0", source: "Firm standard", tags: ["termination","vendor"], is_active: true, created_at: "2026-04-10T00:00:00Z", updated_at: "2026-04-10T00:00:00Z" },
  { id: "ct-6", organization_id: "demo-org", name: "Vendor data-handling addendum", clause_type: "data_protection", text: "Vendor shall not process Customer Data outside the EEA without prior written consent.", description: "Baseline data-handling commitment for non-DPA vendors.", jurisdiction: "EU", contract_type: "vendor_agreement", version: "1.0", source: null, tags: ["data","vendor"], is_active: true, created_at: "2026-04-12T00:00:00Z", updated_at: "2026-04-12T00:00:00Z" },
  { id: "ct-7", organization_id: "demo-org", name: "At-will employment clause", clause_type: "employment_terms", text: "Employment with the Company is at-will and may be terminated by either party at any time.", description: "Standard at-will language for US offers.", jurisdiction: "California", contract_type: "employment_agreement", version: "1.0", source: "Firm standard", tags: ["employment","at-will"], is_active: true, created_at: "2026-04-14T00:00:00Z", updated_at: "2026-04-14T00:00:00Z" },
  { id: "ct-8", organization_id: "demo-org", name: "Non-solicit (12 months)", clause_type: "restrictive_covenant", text: "Employee agrees not to solicit any direct customer or direct report for 12 months following termination.", description: "Used in place of a non-compete clause.", jurisdiction: "California", contract_type: "employment_agreement", version: "1.0", source: null, tags: ["employment","non-solicit"], is_active: true, created_at: "2026-04-18T00:00:00Z", updated_at: "2026-04-18T00:00:00Z" },
  { id: "ct-9", organization_id: "demo-org", name: "Subprocessor notice (DPA)", clause_type: "data_protection", text: "Processor shall give Controller at least 30 days' notice before adding or replacing a Subprocessor.", description: "Notice-and-object subprocessor mechanism.", jurisdiction: "EU", contract_type: "dpa", version: "1.0", source: "Firm standard", tags: ["dpa","subprocessor"], is_active: true, created_at: "2026-04-22T00:00:00Z", updated_at: "2026-04-22T00:00:00Z" },
  { id: "ct-10", organization_id: "demo-org", name: "Standard Contractual Clauses reference", clause_type: "data_transfer", text: "International transfers of Personal Data shall be governed by the EU Standard Contractual Clauses (2021/914).", description: "Default cross-border transfer mechanism.", jurisdiction: "EU", contract_type: "dpa", version: "1.0", source: null, tags: ["dpa","sccs"], is_active: true, created_at: "2026-04-24T00:00:00Z", updated_at: "2026-04-24T00:00:00Z" },
];
