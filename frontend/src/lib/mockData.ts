...
export const MOCK_REQUEST_VENDOR_ID = "00000000-0000-4000-8000-0000000000a4";
export const MOCK_REQUEST_MSA_ID = "00000000-0000-4000-8000-0000000000a5";
export const MOCK_REQUEST_DPA_ID = "00000000-0000-4000-8000-0000000000a6";
export const MOCK_REQUEST_EMPLOYMENT_ID = "00000000-0000-4000-8000-0000000000a7";
export const MOCK_REQUEST_ATLAS_ID = "00000000-0000-4000-8000-0000000000a8";
...
export const MOCK_REQUESTS: ContractRequest[] = [
  ...
  },
  {
    ...
    description:
      "Supporting questions (NDA review):\n• Is this mutual or one-way? Mutual\n• Who is disclosing confidential information? Both parties — primarily product roadmap\n• Preferred confidentiality term? 2 years\n\nAgreement generated from the NDA template and now tracked in the Repository.",
    request_type: "new_contract",
    contract_type: "NDA",
    status: "in_progress",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Supporting questions (NDA review):\n• Is this mutual or one-way? One-way\n• Who is disclosing confidential information? We are disclosing only\n• Preferred confidentiality term? 3 years\n\nGenerated agreement is waiting on legal and finance approval before signature can proceed.",
    request_type: "new_contract",
    contract_type: "NDA",
    status: "blocked",
    priority: "high",
  ...
  // --- Enriched demo seeds: varied contract types, statuses, and priorities ---
  {
    id: MOCK_REQUEST_VENDOR_ID,
    organization_id: MOCK_DEMO_ORG_ID,
    title: "Vendor agreement — Northstar Labs",
    description:
  ...
  {
    id: MOCK_REQUEST_MSA_ID,
    organization_id: MOCK_DEMO_ORG_ID,
    title: "MSA review — Harbor Cloud Services",
    description:
    ...
    request_type: "review_existing",
    contract_type: "msa",
    status: "completed",
    priority: "normal",
    requester_name: "Legal",
    requester_email: null,
    counterparty_name: "Harbor Cloud Services",
    due_date: null,
    assigned_to: null,
    linked_contract_id: null,
    linked_template_id: null,
  ...
  {
    id: MOCK_REQUEST_DPA_ID,
    organization_id: MOCK_DEMO_ORG_ID,
    title: "DPA review — Mesa Data Systems",
    description:
    ...
    requester_name: "Privacy team",
    requester_email: null,
    counterparty_name: "Mesa Data Systems",
    due_date: "2026-06-05",
    assigned_to: null,
    linked_contract_id: null,
    linked_template_id: null,
  ...
  {
    id: MOCK_REQUEST_EMPLOYMENT_ID,
    organization_id: MOCK_DEMO_ORG_ID,
    title: "Employment agreement — Pine & Market HR Consulting",
    description:
    ...
    requester_name: "HR",
    requester_email: null,
    counterparty_name: "Pine & Market HR Consulting",
    due_date: null,
    assigned_to: null,
    linked_contract_id: null,
    linked_template_id: null,
  ...
  {
    id: MOCK_REQUEST_ATLAS_ID,
    organization_id: MOCK_DEMO_ORG_ID,
    title: "NDA renewal — Atlas Robotics",
    description:
    ...
    status: "completed",
    priority: "urgent",
    requester_name: "Business Development",
    requester_email: null,
    counterparty_name: "Atlas Robotics",
    due_date: null,
    assigned_to: null,
    linked_contract_id: null,
    linked_template_id: null,
